...
?>
<title>2.3.17.2 Registrar Autorización Cambio Semana de Alta | <?php echo $nomComp ?></title>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="float-left m-0">2.3.17.2 Registrar Autorización Cambio Semana de Alta</h1>
                        </div>
                        <div class="col-sm-4">
            ...
            $idP = $_GET['idP'];
            $nP = $_GET['nP'];
            $id_regAlta = $_GET['id_regAlta'];
            $folioRegAlta = $_GET['folioRegAlta'];
            ...
            LEFT JOIN semanas S ON CS.semanaAsignado = S.id_semana
            WHERE CS.id_cambioSemAlta = $id_cambioSemAlta";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-sm-12">
                            <div class="card border-card">
                                ...
                                <form id="formUpdateCambioSemAltaAutorizar" autocomplete="off">
                                    <input type="hidden" name="id_cambioSemAlta" id="id_cambioSemAlta" value="<?php echo $id_cambioSemAlta  ?>">
                                    ...
                                    <input type="hidden" name="folioRegAlta" id="folioRegAlta" value="<?php echo $folioRegAlta ?>">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-6 col-sm-12 my-1">
                                                <label class="ml-5 mb-2">Solicitante Cambio de Semana de Alta</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6 col-sm-12 my-1">
                                                <label class="ml-5 mb-2">Fecha Solicitud Cambio de Semana de Alta</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"> <i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                    </div>
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-3 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnUpdateCambioSemAltaAutorizar" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-3 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaUpdateCambioSemAltaAutorizar"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnUpdateCambioSemAltaAutorizar').click(function() {
            $.ajax({
                    url: 'updateCambioSemAltaAutorizar.php',
                    type: 'POST',
                    data: $('#formUpdateCambioSemAltaAutorizar').serialize(),

                })
                .done(function(res) {
                    $('#respuestaUpdateCambioSemAltaAutorizar').html(res)
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnUpdateCambioSemAltaAutorizar").on('click', function() {
