                        ...
                        <div class="col-md-8 col-sm-12">
                            <div class="card border-card">
                                <div class="card-header border-nav">
                                    <h3 class="card-title">Motivo de Cambio de Valor de Alta seleccionado - Número de Proyecto: <strong><?php echo $nP ?></strong></h3>
                                </div>
                                ...
                                <form id="formUpdateAutorizarDescuento" autocomplete="off">
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-6 col-sm-12 my-1">
                                                <label class="ml-5 mb-2">Fecha Autorización<small> *Llenado en automatico</small></label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"> <i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                    </div>
