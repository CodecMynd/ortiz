...
$id_proyecto = $_POST['id_proyectoE3'];
$nProyecto = $_POST['nProyectoE3'];
$id_regSolpzadicional = $_POST['id_regSolpzadicionalE3'];
$id_cotizandoPzsAdic = $_POST['id_cotizandoPzsAdicE3'];
$id_preAutorizadoPzsAdic = $_POST['id_preAutorizadoPzsAdicE3'];
$id_autorizadoPzsAdic = $_POST['id_autorizadoPzsAdicE3'];
$id_AutoProceSurtPzAdic = $_POST['id_AutoProceSurtPzAdicE3'];
$borrado = 1;
...
$etapa = 'Proyecto eliminado en Proceso de Surtido de Piezas: Piezas Adicionales';
...
try {
  ...
  $query3 = ("UPDATE cotizandopzsadic SET autoProceSurtPzAdic = 0, borrado = '$borrado', fecha_borrado = '$date', id_capB = '$id' WHERE id_cotizandoPzsAdic = $id_cotizandoPzsAdic");
  ...
  echo "<div class='alert alert-success' role='alert'>
       <p><strong>Proyecto eliminado en Proceso de Surtido de Piezas: Piezas Adicionales correctamente!</strong></p>
    </div>";
} catch (Exception $e) {
  $conexion->rollback();
