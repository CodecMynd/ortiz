...
$id_proyecto9= $_POST['id_proyecto9'];
...
try {
    ...
    $query1 = "UPDATE proyectos SET autoProceSurtPzAdic = '$autoProceSurtPzAdic', pzsEntregadasAdic = '$pzsEntregadasAdic' WHERE id_proyecto = '$id_proyecto' ";
    $resultado1 = mysqli_query($conexion, $query1);
    // var_dump($query1);

    $query2 = "INSERT INTO pzstregadasadic(id_proyecto, nProyecto, comenPzsEntregadasAdic, folioPzsSurtidaAdic, fecha_creacion, id_capC) VALUES ('$id_proyecto', '$nProyecto', '$comenPzsEntregadasAdic', '$folioPzsSurtidaAdic', '$date', '$id')";
    $resultado2 = mysqli_query($conexion, $query2);
    // var_dump($query2); 


    $query3 = "INSERT INTO bitacorapiezasadicionales(id_regSolpzadicional, id_preAutorizadoPzsAdic, id_proyecto, nProyecto, etapa, folio_autorizPzsAdic, folioPzsSurtidaPzsAdic, fecha_creacion, id_capC) VALUES ('$id_regSolpzadicional','$id_preAutorizadoPzsAdic','$id_proyecto','$nProyecto','$etapa','$folio_autorizPzsAdic', '$folioPzsSurtidaPzsAdic', '$date','$id')";
