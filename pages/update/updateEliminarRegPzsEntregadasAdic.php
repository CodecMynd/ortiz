...
$id_proyecto = $_POST['id_proyectoE4'];
$nProyecto = $_POST['nProyectoE4'];
$id_regSolpzadicional = $_POST['id_regSolpzadicionalE4'];
$id_cotizandoPzsAdic = $_POST['id_cotizandoPzsAdicE4'];
$id_preAutorizadoPzsAdic = $_POST['id_preAutorizadoPzsAdicE4'];
$id_autorizadoPzsAdic = $_POST['id_autorizadoPzsAdicE4'];
$id_AutoProceSurtPzAdic = $_POST['id_AutoProceSurtPzAdicE4'];
$id_pzsEntregadasAdic = $_POST['id_pzsEntregadasAdicE4'];
...
$etapa = 'Proyecto eliminado en Piezas Entregadas: Piezas Adicionales';
...
try {
  ...
  $query3 = ("UPDATE cotizandopzsadic SET pzsEntregadasAdic = 0, borrado = '$borrado', fecha_borrado = '$date', id_capB = '$id' WHERE id_cotizandoPzsAdic = $id_cotizandoPzsAdic");
  ...
  echo "<div class='alert alert-success' role='alert'>
       <p><strong>Proyecto eliminado en Piezas Entregadas: Piezas Adicionales correctamente!</strong></p>
    </div>";
} catch (Exception $e) {
  $conexion->rollback();
