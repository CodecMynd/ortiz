<div class="modal fade modMotivoSupVVAvsVCodID-<?php echo $row["id_proyecto"] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            $query = "SELECT id_proyecto, motivo FROM repvalvenaltavsvalcodid WHERE id_proyecto = $id_proyecto";
            $respuesta = mysqli_query($conexion, $query);
            $rowR = $respuesta->fetch_assoc();
            ?>
            <form id="formUpdateRegMotivoSupVVAvsVCodID" action="../update/updateRegMotivoSupVVAvsVCodID.php" method="POST"> 
