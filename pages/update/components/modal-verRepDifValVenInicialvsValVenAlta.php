...
RA.id_regAlta, RA.folioRegAlta, RA.observAudiFinal, RA.cronometro, RA.supervisionValores,
LV.link, RC.borrado, RC.folioCodID, 
...
?>
<div class="modal fade" id="verGralRepVVIvsVVA-<?php echo $row['id_proyecto'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Supervisión Valor Venta Inicial Vs Valor Alta: Folio <strong><?php echo $row['folioCodID'] ?></strong></h5>
            ...
            <div class="card-body">
                <div class="card card-secondary card-outline collapsed-card">
                    ...
                    if ($SV == 1) {
                        ...
                        FROM proyectos P 
                        INNER JOIN repvalveninicialvsvalvenalta R ON P.id_proyecto = R.id_proyecto
                                    ...
                                    <div class="col-md-12 col-sm-12 my-1">
                                        <div class="form-group-input" style="border: 1px solid #CED4DA;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="motivo" id="motivo" class="form-control" rows="4" placeholder="Max. 200 caracteres" readonly><?php if (!isset($motivo)) {
                                ...
                                <div class="col-md-5 col-sm-12  form-group">
                                    <div class="input-group form-floating">
                                        ...
                                        <input type="text" class="form-control" value="<?php if (!isset($FM)) {
                                                                                            ...
                                                                                            $query3 = "SELECT P.id_proyecto, R.motivo, R.fecha_mod,
                                                                                           UM.nombres AS UMNombre, UM.aPaterno AS UMPaterno, UM.aMaterno AS UMMaterno
                                                                                           FROM proyectos P 
                                                                                           INNER JOIN repvalveninicialvsvalvenalta R ON P.id_proyecto = R.id_proyecto
                                                                                           INNER JOIN usuarios UM ON R.id_capM = UM.id_usuario
                                                                                           WHERE P.id_proyecto = $idP ";
                                                                                            ...
                                                                                            echo $row3['UMNombre'].' '.$row3['UMPaterno'].' '.$row3['UMMaterno'];
                                                                                        } ?>" readonly>
