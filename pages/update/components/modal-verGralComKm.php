...
<div class="modal fade verGralComKm<?php echo $row['id_proyecto'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="card-body">
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Link de Comprobación de Kilometraje </strong></h2>
                    ...
                    <div class="card-body">
                        <?php
                        if ($cK == 1) {
                            $query = "SELECT P.id_proyecto, K.linkComKm, K.fecha_creacion,
                            U.nombres, U.aPaterno, U.aMaterno
                            FROM proyectos P 
                            INNER JOIN comkilometrajes K ON P.id_proyecto = K.id_proyecto
                            INNER JOIN usuarios U ON K.id_capC = U.id_usuario
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input'>
                                        <label for='' class='pl-5'>*Link de Comprobación de Kilometraje</label>
                                        <div class='input-group'>
                                            ...
                                            <input name='link' id='link<?php echo $nP ?>' type='text' class='form-control' value="<?php echo $row['linkComKm'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Supervisión Comprobación de Kilometraje</strong></h2>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool text-dark " data-card-widget="collapse">
                                <i class="fas fa-plus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        if ($cK == 1) {
                            ...
                            WHERE P.id_proyecto = $idP AND C.tipoComprobacion = 'km' ";
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                        <label class='ml-5 mb-2'>Supervisión de Comprobación de Kilometraje</label>
