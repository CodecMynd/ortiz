...
?>
<title>3.2.2 Modificar Motivo Supervisión | <?php echo $nomComp ?></title>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">3.2.2 Modificar Motivo Supervisión</h1>
                        </div>
                        <div class="col-sm-6 ">
            ...
            <!-- consulta sql -->
            <?php
            $id_repVVIvsVVA = $_GET['id'];
            $nP = $_GET['nP'];
            $query = "SELECT id_proyecto, motivo FROM repvalveninicialvsvalvenalta WHERE id_repVVIvsVVA = $id_repVVIvsVVA";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-sm-12">
                            <div class="card border-card">
                                ...
                                <form id="formUpdateUpdateRegMotivoSupVVIvsVVA" autocomplete="off">
                                    <input type="hidden" name="id_repVVIvsVVA" value="<?php echo $id_repVVIvsVVA ?>">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-3 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnUpdateRegMotivoSupVVIvsVVA" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-3 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaUpdateRegMotivoSupVVIvsVVA"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnUpdateRegMotivoSupVVIvsVVA').click(function() {
            $.ajax({
                    url: '../update/updateRegMotivoSupVVIvsVVA.php',
                    type: 'POST',
                    data: $('#formUpdateUpdateRegMotivoSupVVIvsVVA').serialize(),

                })
                .done(function(res) {
                    $('#respuestaUpdateRegMotivoSupVVIvsVVA').html(res)
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnUpdateRegMotivoSupVVIvsVVA").on('click', function() {
