...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
                                            ...
                                            <div class="card-footer border-footer">
                                                <div class="row">
                                                    <div class="col-md-2 col-sm-12 align-self-center">
                                                        <buttom type="submit" id="btnUpdateProyecto" class="btn btn-secondary btn-block btnNuevoUsuario" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                                    </div>
                                                    <!-- <div class="col-md-2 col-sm-12 align-self-center">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                        <div id="respuestaUpdateProyecto"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        // 2.3  update cargar modal de Clientes -----------------------------------------------
        ...
        // 2.3  update cargar modal de Vehiculos -----------------------------------------------
