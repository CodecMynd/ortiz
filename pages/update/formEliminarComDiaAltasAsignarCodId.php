...
?>
<title>2.6.3.4 Eliminar Comprobación de Link de Video en Vivo | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">2.6.3.4 Eliminar Comprobación de Link de Video</h1>
                        </div>
                        <div class="col-sm-6 ">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-sm-12">
                            <div class="card border-card">
                                ...
                                <form id="formDeleteComDiaAltasAsignarCodId" action="../delete/deleteComDiaAltasAsignarCodId.php" method="POST">
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-3 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnDeleteComDiaAltasAsignarCodId" class="btn btn-secondary btn-block btnNuevoUsuario" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-ban"></i> Eliminar</buttom>
                                            </div>
                                            <div class="col-md-3 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaDeleteComDiaAltasAsignarCodId"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
