...
?>
<title>2.3.15.2.2 Registrar Autorización Cambio de Asesor | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="float-left m-0">2.3.15.2.2 Registrar Autorización Cambio de Asesor</h1>
                        </div>
                        <div class="col-sm-4">
