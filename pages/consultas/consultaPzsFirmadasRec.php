...
if ($super == 1 or $verTablaPzsFirmadasRec == 1) {
	...
	WHERE P.estadoProyectoEliminado = 1 AND P.proyectoActivo = 1 AND P.pzsFirmadaRec = 1 AND PF.borrado = 0 GROUP BY P.id_proyecto ORDER BY RC.id_regCompraInicial DESC";
} else {
