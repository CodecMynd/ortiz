...
MAX(SD.fecha_hoyV) AS FV, MAX(SD.fecha_hoyS) AS FS, MAX(SD.id_SegDiaProAseTecnico) AS id_SegDiaProAseTecnico,
ASE.asesor, T.top
FROM proyectos P
...
while ($row = $resultado->fetch_assoc()) {
	...
	} else if ($regComSegDiaAseTecnico == 1 and ($hoyV  == '')) {
		$outputBtns1 = "<a href='../adds/formAddSegDiaAseTecnico.php?id={$idP}' class='btn btn-secondary'><i class='fa-solid fa-pencil'></i></a>";
	} else if ($regComSegDiaAseTecnico == 1 and ($fechaV <> $fecha_sistema)) {
		$outputBtns1 = "<a href='../adds/formAddSegDiaAseTecnico.php?id={$idP}' class='btn btn-secondary'><i class='fa-solid fa-pencil'></i></a>";
	} else if ($regComSegDiaAseTecnico == 1 and ($fechaV ==  $fecha_sistema)) {
		$outputBtns1 = "<a class='btn btn-outline-danger' id='yaRegistrado'><i class='fa-solid fa-pencil'></i></a>";
	} else {
		$outputBtns1 = "<a class='btn btn-outline-danger' id='regComSegDiaAseTecnico'><i class='fa-solid fa-spell-check'></i></a>";
	}
	...
	if ($Eliminado == 0) {
		...
		$outputBtns2 = "<a href='../adds/formAddSupervisionSegDiaAseTecnico.php?id={$id_SegDiaProAseTecnico}' class='btn btn-secondary'><i class='fa-solid fa-pencil'></i></a>";
	...
	} else if ($regSuperSegDiaAseTecnico == 1 and ($hoyV  == '')) {
		$outputBtns2 = "<a class='btn btn-outline-danger' id='elimina'><i class='fa-solid fa-pencil'></i></a>";
	} else if ($regSuperSegDiaAseTecnico == 1 and ($fechaV <> $fecha_sistema)) {
		$outputBtns2 = "<a class='btn btn-outline-danger' id='elimina'><i class='fa-solid fa-pencil'></i></a>";
	} else if ($regSuperSegDiaAseTecnico == 1 and ($hoyS  == '')) {
		$outputBtns2 = "<a href='../adds/formAddSupervisionSegDiaAseTecnico.php?id={$id_SegDiaProAseTecnico}' class='btn btn-secondary'><i class='fa-solid fa-pencil'></i></a>";
	} else if ($regSuperSegDiaAseTecnico == 1 and ($fechaS <> $fecha_sistema)) {
		$outputBtns2 = "<a href='../adds/formAddSupervisionSegDiaAseTecnico.php?id={$id_SegDiaProAseTecnico}' class='btn btn-secondary'><i class='fa-solid fa-pencil'></i></a>";
	} else if ($regSuperSegDiaAseTecnico == 1 and ($fechaS ==  $fecha_sistema)) {
		$outputBtns2 = "<a class='btn btn-outline-danger' id='yaRegistrado'><i class='fa-solid fa-pencil'></i></a>";
	} else {
		$outputBtns2 = "<a class='btn btn-outline-danger' id='regSuperSegDiaAseTecnico'><i class='fa-solid fa-pencil'></i></a>";
	}
