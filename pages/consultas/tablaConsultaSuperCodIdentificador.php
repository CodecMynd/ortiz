...
?>
<title>Tabla Generales Supervisión de Registro Código Identificador| <?php echo $nomComp ?></title>
<style>
                                                ...
                                                <div class='row justify-content-center'>
                                                    ...
                                                    <div class='col-md-5 col-sm-12  form-group'>
                                                        <div class='input-group form-floating'>
                                                            ...
                                                            <input name='' id='' type='text' class='form-control' value='<?php echo $row['Fecha'] ?>' readonly>
