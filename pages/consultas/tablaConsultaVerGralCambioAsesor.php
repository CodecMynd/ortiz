...
?>
<title>Tabla Ver Generales Solicitud Cambio de Asesor | <?php echo $nomComp ?></title>
<style>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-8">
                            <h1 class="m-0">Tabla 2.3.15.2.3 Ver Generales Solicitud Cambio de Asesor</h1>
                        </div>
                        <div class="col-sm-4">
            ...
            $nP = $_GET['nP'];
            $query = "SELECT C.id_cambioAsesor, C.motivo, C.fecha_creacion, C.fecha_mod, C.estatusEspera,
            ...
            AA.asesor AS aseActual, AxA.asesor AS aseAsignar
            FROM cambioasesores C
            INNER JOIN usuarios UC ON C.id_capC = UC.id_usuario
            LEFT JOIN usuarios UM ON C.id_capM = UM.id_usuario
            INNER JOIN asesores AA ON C.asesorActual = AA.id_asesor
            INNER JOIN asesores AxA ON C.asesorAsignado = AxA.id_asesor
            WHERE C.id_cambioAsesor = $id_cambioAsesor ";
            $respuesta = mysqli_query($conexion, $query);
            $row = $respuesta->fetch_assoc();
            $aseActual = $row['aseActual'];
            $aseAsignar = $row['aseAsignar'];
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                <div class="card-header">
                                    <h3 class="card-title">Registro Solicitud Cambio de Asesor en el sistema</h3>
                                ...
                                <div class="card-body">
                                    <div class="card card-secondary card-outline collapsed-card">
                                        <div class="card-header">
                                            <h2 class="card-title"><strong>Solicitud Cambio de Asesor</strong></h2>
                                            <div class="card-tools">
                                            ...
                                            <div class='row justify-content-center'>
                                                <div class="col-md-4 col-sm-12 my-1">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Campo en automatico" value="<?php echo $aseActual ?>" disabled readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-12 my-1">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Campo en automatico" value="<?php echo $aseAsignar ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row justify-content-center">
                                                ...
                                                <div class='col-md-12 col-sm-12 my-1'>
                                                    <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                                        <label class='ml-5 mb-2'>¿Motivo Solicitud Cambio de Asesor?</label>
                                                        <span data-toggle='tooltip' title='max. 200 caracteres'>
                                                            <div class='input-group'>
                                                                <div class='input-group-prepend'>
                                                                    <span class='input-group-text'><i class='fa-solid fa-comments'></i></span>
                                                                </div>
                                                                <textarea name='inspecCalidad' id='inspecCalidad' class='form-control' rows='4' placeholder='Agrega Registro Supervisión de Comprobación de Asesor' readonly><?php echo $row['motivo'] ?></textarea>
                                                            </div>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                                    <div class='input-group form-floating'>
                                                        ...
                                                        <label for='floatingInput' class='pl-5'>Capturista: Solicitante Cambio Asesor</label>
                                                    </div>
                                                </div>
                                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                                    <div class='input-group form-floating'>
                                                        ...
                                                        <label for='floatingInput' class='pl-5'>Fecha: Solicitud Cambio Asesor</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-secondary card-outline collapsed-card">
                                            <div class="card-header">
                                                <h2 class="card-title"><strong>Validación Solicitud Cambio Asesor</strong></h2>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool text-dark " data-card-widget="collapse">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                ...
                                                <div class='row justify-content-center'>
                                                    ...
                                                    <div class='col-md-5 col-sm-12 my-5 form-group'>
                                                        <div class='input-group form-floating'>
                                                            ...
                                                            <label for='floatingInput' class='pl-5'>Fecha: Validación Cambio de Asesor</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
