...
while ($row = $resultado->fetch_assoc()) {
	...
	// // valida columna status Envío de Transmisión
	if (empty($envio)) {
	...
	// // valida columna status Recepción de Transmisión
	if (empty($rec)) {
	...
	if ($Eliminado == 0) {
		...
		$outputBtns2 = "<a class='btn btn-outline-danger' data-toggle='tooltip'  title='Elimina Recepción de Transmisión'><i class='fa-solid fa-trash'></i></a>";
	} else if ($super == 1 and ($envio == 1)) {
					...
					<div class='input-group-prepend'>
						...
						<ul class='dropdown-menu text-center' style='columns: 2; min-width:2em;'>
							<li class='dropdown-item'>
								<span data-toggle='tooltip' title='6.1.1 Registro Envío de Transmisión '>
									" . $outputBtns1 . "
								</span>
							</li>

							<li class='dropdown-item'>
								<span data-toggle='tooltip' title='6.1.2 Eliminar Registro Envío de Transmisión'>
									" . $outputBtns2 . "
								</span>
							</li>
							<li class='dropdown-item'>
								<span data-toggle='tooltip' title='6.1.3 Registro Recepción de Transmisión'>
									" . $outputBtns3 . "
								</span>
							</li>
							<li class='dropdown-item'>
								<span data-toggle='tooltip' title='6.1.4 Eliminar Registro Recepción de Transmisión'>
									" . $outputBtns4 . "
								</span>
							</li>
							<li class='dropdown-item'>
								<span data-toggle='tooltip' title='6.1.5 Ver Generales Envío y Recepción de Transmisión'>
									" . $outputBtns5 . "
								</span>
							</li>
						</ul>
