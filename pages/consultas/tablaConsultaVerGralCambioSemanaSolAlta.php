...
?>
<title>Tabla Ver Generales Solicitud Cambio Semana Solicitud de Alta  | <?php echo $nomComp ?></title>
<style>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="m-0">Tabla 2.3.16.3 Ver Generales Solicitud Cambio Semana Solicitud de Alta</h1>
                        </div>
                        <div class="col-sm-4">
            ...
            $query = "SELECT C.id_cambioSemSolAlta, C.motivo, C.fecha_creacion, C.fecha_mod, C.estatusEspera, C.semanaActual, SA.semana,
            ...
            FROM cambiosemsolalta C 
            INNER JOIN usuarios UC ON C.id_capC = UC.id_usuario
            LEFT JOIN usuarios UM ON C.id_capM = UM.id_usuario 
            INNER JOIN semanasolalta SA ON C.semanaAsignado = SA.id_semSolAlta
            WHERE C.id_cambioSemSolAlta = $id_cambioSemSolAlta ";
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                <div class="card-header">
                                    <h3 class="card-title">Registro Solicitud Cambio de 'Semana Solicitud de Alta' en el sistema</h3>
                                ...
                                <div class="card-body">
                                    <div class="card card-secondary card-outline collapsed-card">
                                        <div class="card-header">
                                            <h2 class="card-title"><strong>Solicitud Cambio de 'Semana Solicitud de Alta'</strong></h2>
                                            <div class="card-tools">
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class='col-md-12 col-sm-12 my-1'>
                                                    <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                                        <label class='ml-5 mb-2'>¿Motivo Solicitud Cambio de 'Semana Solicitud de Alta'?</label>
                                                ...
                                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                                    <div class='input-group form-floating'>
                                                        ...
                                                        <label for='floatingInput' class='pl-5'>Capturista: Solicitante Cambio de 'Semana Solicitud de Alta'</label>
                                                    </div>
                                                </div>
                                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                                    <div class='input-group form-floating'>
                                                        ...
                                                        <label for='floatingInput' class='pl-5'>Fecha: Solicitud Cambio de 'Semana Solicitud de Alta'</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-secondary card-outline collapsed-card">
                                            <div class="card-header">
                                                <h2 class="card-title"><strong>Validación Solicitud Cambio 'Semana Solicitud de Alta'</strong></h2>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool text-dark " data-card-widget="collapse">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-5 col-sm-12 my-1">
                                                        <label class="ml-5 mb-2">Estado Solicitud Cambio 'Semana Solicitud de Alta'</small></label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                ...
                                                <div class='row justify-content-center'>
                                                    <div class='col-md-6 col-sm-12 my-5 form-group'>
                                                        <div class='input-group form-floating'>
                                                            ...
                                                            <label for='floatingInput' class='pl-5'>Capturista: Validador Cambio de 'Semana Solicitud de Alta' (SI / NO)</label>
                                                        </div>
                                                    </div>
                                                    <div class='col-md-6 col-sm-12 my-5 form-group'>
                                                        <div class='input-group form-floating'>
                                                            ...
                                                            <label for='floatingInput' class='pl-5'>Fecha: Validación Cambio de 'Semana Solicitud de Alta'</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
