...
?>
<title>Tabla 2.6.6 Bitácora Código Identificador| <?php echo $nomComp ?></title>
                        ...
                        <div class="col-md-12 col-sm-11">
                            <div class="card border-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="tableBitacoraProyCodId" class="table table-sm table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>ID</th>
