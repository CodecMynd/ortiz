...
?>
<title>2.3.5.1 Registro Motivo Asignación de Top | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="float-left m-0">2.3.5.1 Registro Motivo Asignación de Top</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="card border-card">
                                ...
                                <form id="formNuevoAsignacionTop" autocomplete="off">
                                                ...
                                                <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                                    ...
                                                    <span data-toggle='tooltip' title='max. 200 caracteres'>
                                                        <div class='input-group'>
                                                            ...
                                                            <textarea name='motivo' id='motivo' class='form-control' rows='2' placeholder='Max. 200 caracteres'></textarea>
                                                        </div>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevoAsignacionTop" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevoAsignacionTop"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnNuevoAsignacionTop').click(function() {
            $.ajax({
                    url: '../adds/addNuevoAsignacionTop.php',
                    type: 'POST',
                    data: $('#formNuevoAsignacionTop').serialize(),
                })
                .done(function(res) {
                    $('#respuestaNuevoAsignacionTop').html(res)
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnNuevoAsignacionTop").on('click', function() {
        $("#btnNuevoAsignacionTop").css('visibility', 'hidden');
        setTimeout(function() {
            $("#btnNuevoAsignacionTop").css('visibility', 'visible');
        }, 180000);
    });
</script>
