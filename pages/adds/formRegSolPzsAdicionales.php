...
?>
<title>4.2.1 Registro de Solicitud de Piezas Adicionales | <?php echo $nomComp ?></title>
</head>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-6">
                            <h1 class="m-0">4.2.1 Registro de Solicitud de Piezas Adicionales </h1>
                        </div>
                        <div class="col-sm-6 ">
                                ...
                                <div class="card-footer" style="height: 50px;">
                                    <marquee width="100%" behavior="alternate">
                                        <marquee behavior="alternate">
                                            <p>Consulta optimizada, ultima actualización: <strong>06/06/2022</strong></p>
                                        </marquee>
                                    </marquee>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class='card card-secondary card-outline'>
                                        <div class="card-header border-nav">
                                            <h3 class="card-title">Registro de Solicitud de Piezas Adicionales</h3>
                                            <div class="card-tools">
                                        ...
                                        <div class="card-body">
                                            <div class="row justify-content-center">
                                                <div class="col-md-4 col-sm-4 my-4">
                                                    <div class="card card-secondary card-outline" style="height: 90%;">
                                                        <div class="card-header">
                                                            <h5 class="text-center"><i class="fa-solid fa-magnifying-glass"></i> Buscar <strong>Proyectos Activos para realizar Solicitud de Piezas Adicionales</strong></h5>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group form-group">
                                                                            <button class="btn btn-modal-selector" style="height:120px;" data-toggle="modal" data-target="#modalSelectProyectoSolPzsAdicionales">
                                            ...
                                            <div id="cargarProyectoSolPzsAdicionalesTabla"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    require '../components/modal-selectProyectoSolPzsAdicionales.php';
    ?>
    <script>
        //  iniciar inputMask 
        ...
        // Proyecto Activo para realizar Solicitud de Piezas Adicioniales -------------------------------------------------------------------
        $(document).on("click", ".cargarProyectoSolPzsAdicionales", function() {
            var idProyecto = $(this).data('id_proyecto');
            $.ajax({
                url: "../components/cargarProyectoSolPzsAdicionales.php",
                type: "POST",
                cache: false,
                data: {
                ...
                success: function(data) {
                    $("#cargarProyectoSolPzsAdicionalesTabla").html(data);
                },
            });
        });
    </script>
