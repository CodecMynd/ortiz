...
if ($link == '') {
    ...
    $query = "INSERT INTO registroalta(folioRegAlta, id_proyecto, id_link, fecha_creacion, id_capC) VALUES ( '$folioRegAlta', '$id_proyecto', '$id_link', '$date', '$id')";
    $resultado = mysqli_query($conexion, $query);
    //var_dump($query);


    // Ingresamos id a tabla proyectos modificar registros
    $queryP = "UPDATE `proyectos` SET proyectoActivo = 0, registroSolicitud = 0, altaProyecto = 1 WHERE id_proyecto = $id_proyecto";
