...
?>
<title>1.6.3.1 Registro de Semana de Solicitud de Alta | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">1.6.3.1 Registro de Semana de Solicitud de Alta</h1>
                        </div>
                        <div class="col-sm-6 ">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 col-sm-12">
                            <div class="card border-card">
                                ...
                                <form id="formNuevaSemanaSolAlta" autocomplete="off">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            <div class="col-md-9 col-sm-12 my-1 form-group">
                                                <div class="input-group form-floating mb-3">
                                                    ...
                                                    <label for="floatingInput" class="pl-5">Semana de Solicitud de Alta</label>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <hr>
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12 align-self-center">
                                                <buttom type="button" id="btnNuevaSemanaSolAlta" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-5 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevaSemanaSolAlta"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    // 1.6.3.1 Formulario Crear Semanas Solicitud Alta----------------------------------------------------
    $(document).ready(function() {
        $('#btnNuevaSemanaSolAlta').click(function() {
            var param = $('#formNuevaSemanaSolAlta').serialize();
            $.ajax({
                    url: 'addNuevoSemanaSolAlta.php',
                    type: 'POST',
                    data: param,

                    success: function(vs) {
                        $('#formNuevaSemanaSolAlta')[0].reset();
                    }
                })
                .done(function(res) {
                    $('#respuestaNuevaSemanaSolAlta').html(res)

                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnNuevaSemanaSolAlta").on('click', function() {
