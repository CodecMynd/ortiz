...
$id_regSolpzadicional = $_POST['id_regSolpzadicional1'];
$query2 = "SELECT id_asesor, id_tecArmador FROM registrosolicitudpzsadicionales WHERE id_regSolpzadicional = $id_regSolpzadicional";
$respuesta2 = mysqli_query($conexion, $query2);
$row2 = $respuesta2->fetch_assoc();
$id_asesor = $row2['id_asesor'];
$id_tecArmador = $row2['id_tecArmador'];

$nProyecto = $_POST['nProyecto1'];
$id_cotizandoPzsAdic = $_POST['id_cotizandoPzsAdic1'];
...
$borrado = 0;
$pzadicionial = 1;
$etapa = 'Se Agrego nueva Solicitud de Pieza Adicional';
...
if ($row['estadoProyectoEliminado'] == 0) {
    ...
    try {
        ...
        $query2 = "INSERT INTO bitacorapiezasadicionales(id_regSolpzadicional, id_proyecto, nProyecto, folio_autorizPzsAdic, folioPzsSurtidaPzsAdic, etapa, fecha_creacion, id_capC) VALUES ('$id_regSolpzadicional', '$id_proyecto', '$nProyecto', '--', '--', '$etapa', '$date', '$id')";
