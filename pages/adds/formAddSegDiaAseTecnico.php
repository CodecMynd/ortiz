...
?>
<title>2.3.6.1.1 Registro Comprobación de Seguimiento Diario Programa de Asesoramiento Técnico | <?php echo $nomComp ?></title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="card border-card">
                                ...
                                <form id="formNuevoRegSegDiaAseTecnico" autocomplete="off">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevoRegSegDiaAseTecnico" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevoRegSegDiaAseTecnico"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnNuevoRegSegDiaAseTecnico').click(function() {
            $.ajax({
                    url: '../adds/addNuevoRegComSegDiaAseTecnico.php',
                    type: 'POST',
                    data: $('#formNuevoRegSegDiaAseTecnico').serialize(),
                })
                .done(function(res) {
                    $('#respuestaNuevoRegSegDiaAseTecnico').html(res)
                    // window.location.href = '../admin/crudActividadMinimaDiaria.php'
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnNuevoRegSegDiaAseTecnico").on('click', function() {
