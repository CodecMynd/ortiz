...
?>
<title>2.6.4.2 Registrar Supervisión Seguimiento Diario de Cobranza | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="float-left m-0">2.6.4.2 Registrar Supervisión Seguimiento Diario de Cobranza</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-sm-12">
                            <div class="card border-card">
                                ...
                                <form id="formNuevoComSegDiaCobranzaSuper" autocomplete="off">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevoComSegDiaCobranzaSuper" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevoComSegDiaCobranzaSuper"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnNuevoComSegDiaCobranzaSuper').click(function() {
            $.ajax({
                    url: '../adds/addNuevoComSegDiaCobranzaSuper.php',
                    type: 'POST',
                    data: $('#formNuevoComSegDiaCobranzaSuper').serialize(),
                })
                .done(function(res) {
                    $('#respuestaNuevoComSegDiaCobranzaSuper').html(res)
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnNuevoComSegDiaCobranzaSuper").on('click', function() {
        $("#btnNuevoComSegDiaCobranzaSuper").css('visibility', 'hidden');
        setTimeout(function() {
            $("#btnNuevoComSegDiaCobranzaSuper").css('visibility', 'visible');
        }, 300000);
    });
</script>
