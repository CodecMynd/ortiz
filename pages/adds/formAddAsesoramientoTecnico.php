...
?>
<title>2.3.6.1 Registro Programa de Asesoramiento Técnico | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="float-left m-0">2.3.6.1 Registro Programa de Asesoramiento Técnico</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="card border-card">
                                ...
                                <form id="formNuevoAseTec" autocomplete="off">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevoAseTec" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevoAseTec"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnNuevoAseTec').click(function() {
            $.ajax({
                    url: '../adds/addNuevoAseTec.php',
                    type: 'POST',
                    data: $('#formNuevoAseTec').serialize(),
                })
                .done(function(res) {
                    $('#respuestaNuevoAseTec').html(res)
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnNuevoAseTec").on('click', function() {
