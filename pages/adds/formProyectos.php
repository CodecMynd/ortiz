                                                    ...
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="col-md-3 col-sm-12 my-1">
                                                            <div class="input-group form-floating mb-3">
                                                                ...
                                                                <input name="valorVenta" id="valorVenta" type="text" class="form-control" placeholder="Valor Venta Inicial" data-toggle="tooltip" data-placement="bottom" title="Ingresa Valor en módulo 2.3.6 Captura Valor Venta Inicial" value="0.00" readonly>
