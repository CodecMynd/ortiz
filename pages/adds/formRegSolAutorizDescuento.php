...
?>
<title>2.10.1.1 Solicitar Autorización de Descuento | <?php echo $nomComp ?></title>
</head>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-6">
                            <h1 class="m-0">2.10.1.1 Solicitar Autorización de Descuento</h1>
                        </div>
                        <div class="col-sm-6 ">
                            ...
                            <div class="row">
                                ...
                                <div class='card card-secondary card-outline'>
                                    <div class="card-header border-nav">
                                        <h3 class="card-title">Proyectos Para Solicitar Autorización de Descuento</h3>
                                            ...
                                            <div class="col-md-4 col-sm-4 my-4">
                                                <div class="card card-secondary card-outline" style="height: 90%;">
                                                    <div class="card-header">
                                                        <h5 class="text-center"><i class="fa-solid fa-magnifying-glass"></i> Buscar <strong>Proyectos Para Solicitar Autorización de Descuento</strong></h5>
                                                    </div>
    ...
    require '../components/modal-selectProyectoSolAutorizDescuento.php';
    ?>
    <!-- avisos -->
    <script src="../../src/js/toastr.js"></script>
    <script>
        // 2.3  Registro Proyectos cargar Modal de Proyectos -----------------------------------------------
        $(document).on("click", ".cargarProyectoSolAutorizDescuento", function() {
            var idProyecto = $(this).data('id_proyecto');
            $.ajax({
                url: "../components/cargarProyectoSolAutorizDescuento.php",
                type: "POST",
                cache: false,
                data: {
