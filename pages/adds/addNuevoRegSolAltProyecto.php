...
$query = "INSERT INTO registrosolicitud(folioRegSolicitud, id_proyecto, valorVentaAlta, fecha_creacion, id_capC) VALUES ( '$folioRegSolicitud', '$id_proyecto', '$valorVentaAlta', '$date', '$id')";
