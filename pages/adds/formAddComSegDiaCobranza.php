...
?>
<title>2.6.4.1 Registrar Comprobación de Seguimiento Diario de Cobranza | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="float-left m-0">2.6.4.1 Registrar Seguimiento Diario de Cobranza</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="card border-card">
                                ...
                                <form id="formNuevoComSegDiaCobranza" autocomplete="off">
                                                ...
                                                <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                                    ...
                                                    <span data-toggle='tooltip' title='max. 200 caracteres'>
                                                        <div class='input-group'>
                                                            ...
                                                            <textarea name='linkComSegDiaCobranza' id='linkComSegDiaCobranza' class='form-control' rows='2' placeholder='Max. 200 caracteres'></textarea>
                                                        </div>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevoComSegDiaCobranza" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevoComSegDiaCobranza"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnNuevoComSegDiaCobranza').click(function() {
            $.ajax({
                    url: '../adds/addNuevoComSegDiaCobranza.php',
                    type: 'POST',
                    data: $('#formNuevoComSegDiaCobranza').serialize(),
                })
                .done(function(res) {
                    $('#respuestaNuevoComSegDiaCobranza').html(res)
                })
        });
    });
    //Ocultar boton por 5 minutos para evitar el doble submit
    $("#btnNuevoComSegDiaCobranza").on('click', function() {
