            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">1.6.2.1 Registro Semana de Cobro</h1>
                        </div>
                        <div class="col-sm-6 ">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-4">
                            <div class="card border-card">
                                ...
                                <form id="formNuevaSemanaCobro" autocomplete="off">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 col-sm-12 my-1 form-group">
                                                <div class="input-group form-floating mb-3">
                                                    ...
                                                    <input autofocus name="semanaCobro" id="semanaCobro" type="text" class="form-control" placeholder="Ingresa Año - Semana" required maxlength="7" data-toggle="tooltip" data-placement="bottom" title="Ingresa Año - Semana" data-inputmask="'mask' : '9999-99'"> 
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevaSemanaCobro" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-5 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevaSemanaCobro"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
