...
<div class="modal fade verGralComGarantia<?php echo $row['id_proyecto'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="card-body">
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Link de Comprobación de Garantia </strong></h2>
                    ...
                    <div class="card-body">
                        <?php
                        if ($cG == 1) {
                            $query = "SELECT P.id_proyecto, C.linkComGarantia, C.fecha_creacion,
                            U.nombres, U.aPaterno, U.aMaterno
                            FROM proyectos P 
                            INNER JOIN comgarantias C ON P.id_proyecto = C.id_proyecto
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input'>
                                        <label for='' class='pl-5'>*Link de Comprobación de Garantia</label>
                                        <div class='input-group'>
                                            ...
                                            <input name='link' id='link<?php echo $nP ?>' type='text' class='form-control' value="<?php echo $row['linkComGarantia'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                    <div class='input-group form-floating'>
                                        ...
                                        <label for='floatingInput' class='pl-5'>Capturista: Registro Comprobación de Garantias</label>
                                    </div>
                                </div>
                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                    <div class='input-group form-floating'>
                                        ...
                                        <label for='floatingInput' class='pl-5'>Fecha: Registro Comprobación de Garantias</label>
                                    </div>
                                </div>
                            </div>
                        <?php
                ...
                <div class="col-12">
                    <hr>
                    <h5 class="mt-3">Registro Supervisión de Comprobación de Garantia: Número de Proyecto <strong><?php echo $nP ?></strong></h5>
                    <hr>
                </div>
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Supervisión Comprobación de Garantia</strong></h2>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool text-dark " data-card-widget="collapse">
                                <i class="fas fa-plus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        if ($cSG == 1) {
                            ...
                            INNER JOIN usuarios U ON C.id_capC = U.id_usuario
                            WHERE P.id_proyecto = $idP AND C.tipoComprobacion = 'garantia' ";
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                        <label class='ml-5 mb-2'>Supervisión de Comprobación de Garantia</label>
                                        <span data-toggle='tooltip' title='max. 300 caracteres'>
                                            <div class='input-group'>
                                                <div class='input-group-prepend'>
                                                    <span class='input-group-text'><i class='fa-solid fa-comments'></i></span>
                                                </div>
                                                <textarea name='inspecCalidad' id='inspecCalidad' class='form-control' rows='4' placeholder='Agrega Registro Supervisión de Comprobación de Garantia' readonly><?php echo $row1['textSupervision']; ?></textarea>
                                            </div>
                                        </span>
                                    </div>
                                </div>
