                                                            ...
                                                            <div class="input-group-prepend">
                                                                ...
                                                                <ul class="dropdown-menu" style="columns:2; min-width:2em;">
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="2.3.2.2.1 Registrar Comprobación de Placa">
                                                                            <?php if ($Eliminado == 0) {
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="2.3.2.2.3 Registrar Supervisión Comprobación de Placa">
                                                                            <?php if ($cP == 0) {
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="2.3.2.2.5 Ver Generales Comprobación de Placas">
                                                                            <?php if ($super == 1) { ?>
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="2.3.2.2.2 Eliminar Comprobación de Placa">
                                                                            <?php if ($cS == 1) {
                                                                    ...
                                                                    <!-- <div class="dropdown-divider"></div> -->
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="2.3.2.2.4 Eliminar Supervisión Comprobación de Placa">
                                                                            <?php if ($Eliminado == 0) {
                                                                                echo '<a class="btn btn-outline-danger" id="eliminado"><i class="fa-solid fa-ban"></i></a>';
