                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="2.3.4 Eliminar Proyecto">
                                                                            ...
                                                                            if ($super == 1 && $pActivo == 1) {
                                                                                echo  '<a class="btn btn-secondary" data-toggle="modal" data-target=".borrarProyecto<{$row["id_proyecto"]}"><i class="fas fa-trash-alt"></i>
                                                                                        </a>';
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#noEliProyecto ").click(function() {
                toastr["error"]("¡PROYECTO EN USO, NO SE PUEDE ELIMINAR")
