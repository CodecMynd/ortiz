...
?>
<title>CRUD Semanas | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tabla 1.6 Semanas</h1>
                        </div>
                        <div class="col-sm-6 ">
                            ...
                            <div class="card border-card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <?php if ($super == 1) { ?>
                                            <a type="button" class="btn btn-secondary" href="../adds/formAddSemana.php" data-toggle="tooltip" data-placement="left" title="1.6.1 Registro de Semanas">
                                                <i class="fa-solid fa-calendar-days"></i>&nbsp;&nbsp; Registro de Semana</a>
                                        <?php } else if ($regSemana  == 1) { ?>
                                            <a type="button" class="btn btn-secondary" href="../adds/formAddSemana.php" data-toggle="tooltip" data-placement="left" title="1.6.1 Registro de Semanas">
                                                <i class="fa-solid fa-calendar-days"></i>&nbsp;&nbsp; Registro de Semana</a>
                                        <?php } else { ?>
                                            <a type="button" class="btn btn-outline-danger" id="regSemana" data-toggle="tooltip" data-placement="left" title="1.6.1 Registro de Semanas">
                                                <i class="fa-solid fa-calendar-days"></i>&nbsp;&nbsp; Registro de Semana</a>
                                        <?php } ?>
                                            ...
                                            while ($row = $resultado->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td class="row justify-content-center">
                                                        <span data-toggle="tooltip" title="1.6.2  Eliminar Semana">
                                                            <?php if ($super == 1) { ?>
