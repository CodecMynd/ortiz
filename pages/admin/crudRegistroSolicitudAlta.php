                    ...
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <div class="card border-card">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <?php } else if ($regSolAltProy == 1) { ?>
                                            <a type="button" class="btn btn-secondary" href="../adds/formRegSolicitudAlta.php" data-toggle="tooltip" data-placement="left" title="2.4.2.1 Registro de Solicitud Alta Proyecto">
                                                <i class="fa-solid fa-file-arrow-up"></i></i>&nbsp;&nbsp; Registro Solicitud Alta</a>
                                        <?php } else { ?>
                                            <a type="button" class="btn btn-outline-danger" id="regSolAltProy" data-toggle="tooltip" data-placement="left" title="2.4.2.1 Registro de Solicitud Alta Proyecto">
                                                <i class="fa-solid fa-file-arrow-up"></i></i>&nbsp;&nbsp; Registro Solicitud Alta</a>
                                        <?php } ?>
                                ...
                                $cont = 0;
                                if ($super == 1) {
                                    $query = "SELECT P.id_proyecto, P.nProyecto, P.nOrden, P.proyectoActivo, P.registroSolicitud, V.placa, M.marca, Mo.modelo, A.anio, R.folioRegSolicitud, Co.color
                                    FROM proyectos P 
