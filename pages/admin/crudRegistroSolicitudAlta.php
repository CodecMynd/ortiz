...
<script>
    function abrirModal1(id_proyecto, nProyecto, id_regSolicitud, folioRegSolicitud) {
        $("#btbModal-regresarRegSolAltProy").click();
        $("#id_proyecto").val(id_proyecto);
        $("#id_regSolicitud").val(id_regSolicitud);
        $("#folioRegSolicitud").val(folioRegSolicitud);
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
    ...
    ?>
    <script src="../ajax/crudRegistroSolicitudAlta.js"></script>
...
<!-- 
SELECT P.id_proyecto, P.nProyecto, P.nOrden, P.valorVenta, V.placa, M.marca, Mo.modelo, A.anio, 
