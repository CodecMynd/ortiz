...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                ...
                                $cont = 0;
                                if ($super == 1) {
                                    $query = "SELECT P.id_proyecto, P.nProyecto, P.nOrden, P.comKm, P.estadoProyectoEliminado, P.comSuperKm,
                                    ...
                                    <table id="tablePermisos" class="table table-sm table-bordered table-striped" style="width: 100%;">
                                        ...
                                        <tbody>
                                                            ...
                                                            <div class="input-group-prepend">
                                                                ...
                                                                <ul class="dropdown-menu" style="columns:2; min-width:2em;">
                                                                    <!-- <div class="btn-group"> -->
                                                                        <li class="dropdown-item">
                                                                            <span data-toggle="tooltip" title="2.3.10.1 Registrar Comprobación de Kilometraje">
                                                                                ...
                                                                                <?php } else if ($super == 1 && $cK == 1) {
                                                                                    echo '<a class="btn btn-outline-danger" id="siRegComKm"><i class="fa-solid fa-pencil"></i>
                                                                            </a>';
                                                                                ...
                                                                                <?php  } else if ($regComKm == 1 && $cK == 1) {
                                                                                    ...
                                                                                    echo '<a class="btn btn-outline-danger" id="regComKm"><i class="fa-solid fa-pencil"></i></a>';
                                                                                } ?>
                                                                            </span>
                                                                        </li>

                                                                        <li class="dropdown-item">
                                                                            <span data-toggle="tooltip" title="2.3.10.3 Registrar Supervisión Comprobación de Kilometraje">
                                                                                <?php if ($Eliminado == 0) {
                                                                                    echo '<a class="btn btn-outline-danger" id="noComPlacas"><i class="fa-solid fa-ban"></i></a>';
                                                                                } else if ($super == 1 && $cSK == 0) { ?>
                                                                                    <button class="btn btn-secondary" data-toggle="modal" data-target=".regComKmSuper-<?php echo $idP ?>"><i class="fa-solid fa-spell-check"></i>
                                                                                    </button>
                                                                                <?php } else if ($super == 1 && $cSK == 1) {
                                                                                    echo '<a class="btn btn-outline-danger" id="siRegComSuperKm"><i class="fa-solid fa-spell-check"></i></a>';
                                                                                } else if ($regComPlacas == 1 && $cSK == 0) { ?>
                                                                                    <button class="btn btn-secondary" data-toggle="modal" data-target=".regComKmSuper-<?php echo $idP ?>"><i class="fa-solid fa-spell-check"></i>
                                                                                    </button>
                                                                                <?php  } else if ($regComPlacas == 1 && $cSK == 1) {
                                                                        ...
                                                                        <li class="dropdown-item">
                                                                            <span data-toggle="tooltip" title="2.3.10.5 Ver Generales Comprobación de Kilometraje">
                                                                                <?php if ($super == 1) { ?>
                                            ...
                                            <?php
                                                ...
                                                require '../components/modal-regComKmSuper.php';
                                                require '../components/modal-eliminarComKmSuper.php';
    ...
    <script>
         // noComKm PROYECTO ELIMINADO, NO SE PUEDE REALIZAR ESTA ACCION --------------------------------------------------------------
         $(document).ready(function() {
            $("#noComKm ").click(function() {
        ...
        // noEliComKm NO TIENE COMPROBACION DE KILOMETRAJE, NO HAY NADA QUE BORRAR --------------------------------------------------------------
        $(document).ready(function() {
        ...
        // siRegComKm NO SE PUEDE VOLVER A REGISTRAR UNA COMPROBACION DE KILOMETRAJE --------------------------------------------------------------
        $(document).ready(function() {
            $("#siRegComKm ").click(function() {
                toastr["error"]("¡NO SE PUEDE VOLVER A REGISTRAR UNA COMPROBACION DE KILOMETRAJE!")
             ...
             // siRegComSuperKm NO SE PUEDE VOLVER A REGISTRAR UNA SUPERVISION DE COMPROBACION DE KILOMETRAJE --------------------------------------------------------------
             $(document).ready(function() {
            $("#siRegComSuperKm ").click(function() {
                toastr["error"]("¡NO SE PUEDE VOLVER A REGISTRAR UNA SUPERVISION DE COMPROBACION DE KILOMETRAJE!")
        ...
        //  2.3.10.2 Eliminar Comprobación de Placa ------------------------------------------------------------
        ...
        //  2.3.10.4 Eliminar Supervision Comprobación de Placa ------------------------------------------------------------
        $('.btnBorrarComKmSuper').click(function(e) {
            e.preventDefault();
            if (confirm("¿Estás seguro de eliminar esta Supervisión de Comprobación de Kilometraje? Una vez borrado ya no se podrá recuperar la información.")) {
                var id = $(this).attr("id");

                var dataString = 'id=' + id;
                url = "../delete/deleteComKmSuper.php";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: dataString,
