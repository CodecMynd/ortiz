...
?>
<title>CRUD Asignación de Top | <?php echo $nomComp ?></title>
<style>
    .top:hover {
        transform: scale(1.5);
        transition: all 0.5s;
...
<script>
    function abrirModal1(id_proyecto, nProyecto, id_top) {
        $("#btnModal-eliminarAsignacionTop").click();
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
                ...
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8 col-md-8 col-lg-8">
                            <h1 class="m-0">Tabla 2.3.5 Asignación de Top</h1>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                ...
                                <div id="respuestaEliminarAsignacionTop"></div>
                                <div class="card-body">
                                    <?php
                                    if ($super == 1) {
                                    } else if ($vertablaAsignacionTop == 0) { ?>
                                        <div class="ribbon ribbon-top-left"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-top-right"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-bottom-left"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-bottom-right"><span>Sin permiso</span></div>
                                    <?php } ?>
                                    <table id="tableAsignacionTop" class="display compact table-bordered table-striped" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>ID</th>
                                                ...
                                                <th style="color:#fff; background-color: #5A6268;">Top</th>
                                                <th>Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                    ...
                                    <button id="btnModal-eliminarAsignacionTop" class='btn btn-white' data-toggle='modal' data-target='.borrarAsignacionTop'></button>
                                    <?php
                                    require '../components/modal-eliminarAsignacionTop.php';
                                    desconectar();
                                    ?>
                                </div>
                            </div>
    ...
    <!-- avisos -->
<script>
    $('#btnEliminarAsignacionTop').click(function () {
    $.ajax({
            url: '../delete/deleteAsignacionTop.php',
            type: 'POST',
            data: $('#formEliminarAsignacionTop').serialize(),
        })
        .done(function (res) {
...
$("#btnEliminarAsignacionTop").on('click', function () {
