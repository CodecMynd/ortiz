...
?>
<title>CRUD Seguimiento Diario Programa de Asesoramiento Técnico | <?php echo $nomComp ?></title>
<style>
                ...
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8 col-md-8 col-lg-8">
                            <h1 class="m-0">Tabla 2.3.6.1 Seguimiento Diario Programa de Asesoramiento Técnico</h1>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                ...
                                <div class="card-body">
                                    <?php
                                    if ($super == 1) {
                                    } else if ($verTablaSegDiaProAseTecnico == 0) { ?>
