...
?>
<title>CRUD Solicitar Cambio de Semana de Solicitud de Alta | <?php echo $nomComp ?></title>
<style>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8">
                            <h1 class="m-0">Tabla 2.3.16 Solicitar Cambio de Semana de Solicitud de Alta</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                <div class="card-header">
                                    <h3 class="card-title">Solicitudes para Cambio de Semana de Solicitud de Alta</h3>
                                    <div class="card-tools">
                                        <?php if ($super == 1 or $solCamSemanaSolAltas == 1) { 
                                           echo '<a type="button" class="btn btn-secondary" href="../adds/formRegSolAltaCamSemanaSolAlta.php" data-toggle="tooltip" data-placement="left" title="2.3.16.1  Solicitar Cambio Semana Solicitud de Alta"><i class="fa-solid fa-calendar-xmark"></i>&nbsp;&nbsp; Solicitar Cambio Semana Solicitud de Alta</a>';
                                        } else { 
                                            echo '<a type="button" class="btn btn-outline-danger" id="solCamSemanaSolAltas" data-toggle="tooltip" data-placement="left" title="2.3.16.1 Solicitar Cambio Semana Solicitud de Alta"><i class="fa-solid fa-calendar-xmark"></i>&nbsp;&nbsp; Solicitar Cambio Semana Solicitud de Alta</a>';
                                        } ?>
                                ...
                                <div class="card-body">
                                    <?php
                                    if ($super == 1) {
                                    } else if ($verTablaSolCamSemanaSolAltas == 0) { ?>
                                        <div class="ribbon ribbon-top-left"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-top-right"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-bottom-left"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-bottom-right"><span>Sin permiso</span></div>
                                    <?php } ?>
                                    <table id="tableSolCamSemanaSolAltas" class="table table-sm table-bordered table-striped" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>ID</th>
                                                ...
                                                <th>Núm. Folio Solicitud Cambio Semana Solicitud de Alta</th>
                                                <th>Estado Solicitud Cambio Semana Solicitud de Alta</th>
                                                <th>Semana Solicitud de Alta Actual</th>
                                                <th>Semana Solicitud de Alta por Asignar</th>
                                                <th>Núm. Proyecto</th>
                                                <th>Núm. Orden</th>
                                                <th>Marca</th>
                                                <th>Modelo</th>
    ...
    ?>
    <!-- avisos -->
    <script src="../ajax/crudSolicitudCambioSemanaSolAlta.js"></script>
</body>
