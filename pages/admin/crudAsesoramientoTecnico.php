...
?>
<title>CRUD Programa de Asesoramiento Técnico | <?php echo $nomComp ?></title>
<style>
    .top:hover {
        transform: scale(1.5);
        transition: all 0.5s;
...
<script>
    function abrirModal1(id_proyecto, nProyecto, id_aseTec) {
        $("#btnModal-eliminarAsesoramientoTecnico").click();
        $("#id_proyecto").val(id_proyecto);
        $("#id_aseTec").val(id_aseTec);
                ...
                <div class="container-fluid">
                    <div class="row my-3 mx-1">
                        <div class="col-sm-8 col-md-8 col-lg-8">
                            <h1 class="m-0">Tabla 2.3.6 Programa de Asesoramiento Técnico </h1>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-sm-12">
                            <div class="card border-card">
                                ...
                                <div id="respuestaEliminarAseTecnico"></div>
                                <div class="card-body">
                                    <?php
                                    if ($super == 1) {
                                    } else if ($vertablaAseTec == 0) { ?>
                                        <div class="ribbon ribbon-top-left"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-top-right"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-bottom-left"><span>Sin permiso</span></div>
                                        <div class="ribbon ribbon-bottom-right"><span>Sin permiso</span></div>
                                    <?php } ?>
                                    <table id="tableAsesoramientoTecnico" class="display compact table-bordered table-striped" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>ID</th>
                                    ...
                                    <button id="btnModal-eliminarAsesoramientoTecnico" class='btn btn-white' data-toggle='modal' data-target='.borrarAseTec'></button>
                                    <?php
                                    require '../components/modal-eliminarAsesoramientoTecnico.php';
                                    desconectar();
                                    ?>
                                </div>
                            </div>
