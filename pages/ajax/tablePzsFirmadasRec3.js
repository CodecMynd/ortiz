...
//  });
 ...
 var tablePzsFirmadasRec3 = $("#tablePzsFirmadasRec3").DataTable({
     "responsive": true,
     "lengthChange": true,
     "autoWidth": true,
     "stateSave": false,
     ...
     "ajax": {
         url: "../consultas/consultaPzsFirmadasRec3.php",
         type: "get",
         dataType: "json",
         error: function (e) {
 ...
 setInterval(function () {
     tablePzsFirmadasRec3.ajax.reload(null, false); // user paging is not reset on reload
 }, 360000);
 //----------------------------------------------------------------------------------------------------------------------------------------------------------------------
