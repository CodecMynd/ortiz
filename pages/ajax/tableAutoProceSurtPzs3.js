...
var tableAutoProceSurtPzs3 = $("#tableAutoProceSurtPzs3").DataTable({
    "responsive": true,
    "lengthChange": true,
    "autoWidth": true,
    "stateSave": false,
    ...
    "ajax": {
        url: "../consultas/consultaAutoProceSurtPzs3.php",
        type: "get",
        dataType: "json",
        error: function (e) {
...
setInterval(function () {
    tableAutoProceSurtPzs3.ajax.reload(null, false); // user paging is not reset on reload
}, 360000);
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
