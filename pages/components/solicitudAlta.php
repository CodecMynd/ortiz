...
$query = 'SELECT P.id_proyecto, P.nProyecto, P.nOrden, P.tipoReparacion, P.km, P.valorVenta, P.diagnostico, P.descripServ1, P.descripServ2, V.placa, M.marca, Mo.modelo, A.anio, Co.color, R.folioRegSolicitud, R.valorVentaAlta, R.fecha_creacion, S.semana, U.nombres, U.aPaterno, U.aMaterno 
FROM proyectos P 
        ...
        <div class="container-fluid" style="width:107%">
            <div class="col-md-12">
                <ul class="float-right">
                    ...
                    <li>Fecha Solicitud Alta <input type="text" value="<?php echo $row['fecha_creacion'] ?>" style="width:100px;"></li>
