...
R.inspecCalidad, R.observCliente, R.descripcionFinal, R.fecha_creacion, S.semana 
FROM proyectos P 
    ...
    <div class='card-footer border-footer'>
        <div class='row'>
            <div class='col-md-2 col-sm-12 align-self-center'>
                <buttom type='submit' id='btnNuevoRegAltaProyecto' class='btn btn-secondary btn-block btnNuevoUsuario' data-toggle='tooltip' data-placement='bottom' title='Guardar '><i class='fas fa-pen'></i>
                    Guardar</buttom>
            </div>
            <div class='col-md-2 col-sm-12 align-self-center'>
...
<script>
    $(document).ready(function() {
        $('#btnNuevoRegAltaProyecto').click(function() {
            $.ajax({
                    url: 'addNuevoRegAltaProyecto.php',
                    type: 'POST',
                    data: $('#formNuevoRegAltaProyecto').serialize(),
    ...
    $("#btnNuevoRegAltaProyecto").on('click', function() {
        $("#btnNuevoRegAltaProyecto").css('visibility', 'hidden');
        setTimeout(function() {
            $("#btnNuevoRegAltaProyecto").css('visibility', 'visible');
        }, 300000);
    });
