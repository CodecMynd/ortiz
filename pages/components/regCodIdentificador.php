...
<body>
    ...
    <main>
        <div>
            <span class="paginacion">Página 1 de 2</span>
        </div>
        ...
        <div class="container ">
            <div class="col-12">
                ...
                <br>
                <div>
                    <span class="paginacion">Página 2 de 2</span>
                </div>
                <div class="lineaHeader"><img src="../../src/img/logos/headerSolicitudAltaLinea.png" /></div>
                <div class="container-fluid" style="width:107%">
                    <div class="col-md-12">
