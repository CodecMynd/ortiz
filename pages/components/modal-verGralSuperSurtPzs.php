    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">4.1.8.3 Ver Tabla Supervisión de Surtido de Piezas del Número de Proyecto: <strong><?php echo $row['nProyecto'] ?></strong></h5>
