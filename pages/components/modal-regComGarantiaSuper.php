<div class="modal fade regComGarantiaSuper-<?php echo $idP ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    Registrar Supervisión de Comprobacion de Garantia de Número de Proyecto: <?php echo $nP ?>
                </h5>
            </div>
            <form id="formNuevoRegMotivoSupVVAvsVCodID" action="../adds/addNuevoRegComGarantiaSuper.php" method="POST"> 
            ...
            <div class="pie">
                <h5>2.3.14.3 Registrar Supervisión Comprobación de Garantia</h5>
            </div>
        </div>
    </div>
</div>