            ...
            <div class='row justify-content-center'>
                ...
                <div class='col-md-12 col-sm-12 my-1'>
                    <div class='row justify-content-center'>
                        ...
                        <div class='col-md-3 col-sm-12 mb-2'>
                            <div class='input-group'>
                                <label for='color' class='parpadea'>Asesor</label>
                                <select name='id_asesor' id='id_asesor' class='form-control' data-toggle='tooltip' data-placement='bottom' title='Selecciona un Asesor de la lista' style='width: 100%;'   required>
                                    ...
                                    while ($rowA = $resultAsesor->fetch_assoc()) {
                                    $id_asesor = $rowA['id_asesor'];
                                    $asesor = $rowA['asesor'];
                        ...
                        <div class='col-md-3 col-sm-12 mb-2'>
                            <div class='input-group'>
                                <label for='color' class='parpadea'>Técnico Armador</label>
                                <select name='id_tecArmador' id='id_tecArmador' class='form-control' data-toggle='tooltip' data-placement='bottom' title='Selecciona un Proveedor de la lista' style='width: 100%;'   required>
                                    <option selected disabled>Selecciona</option>";
