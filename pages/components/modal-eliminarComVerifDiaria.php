...
<div class="modal fade eliminarComVerifDiaria-<?php echo $row['id_comverifdiariaveh'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
