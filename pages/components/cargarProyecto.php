                            ...
                            <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                ...
                                <span data-toggle='tooltip' title='max. 300 caracteres'>
                                    <div class='input-group'>
                                        ...
                                        <textarea name='inspecCalidad' id='inspecCalidad' class='form-control' rows='4' placeholder='Agrega alguna breve Observación de Inspección de Control Calidad' maxlength='300' required></textarea>
                                    </div>
                                </span>
                            </div>
                        </div>
                            ...
                            <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                ...
                                <span data-toggle='tooltip' title='max. 300 caracteres'>
                                    <div class='input-group'>
                                        ...
                                        <textarea name='observCliente' id='observCliente' class='form-control' rows='4' placeholder='Agrega alguna breve Observación para nuestro Cliente' maxlength='300' required></textarea>
                                    </div>
                                </span>
                            </div>
                        </div>
