...
<div class="modal fade" id="verLinkVideoCodId-<?php echo $row['id_proyecto'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Registro con Código Identificador: Código <strong><?php echo $row['codIdentificador'] ?></strong></h5>
            ...
            <div class="card-body">
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Generales: <?php echo $row['codIdentificador'] ?></strong></h2>
