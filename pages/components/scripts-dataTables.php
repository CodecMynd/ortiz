    ...
    <script>
        ...
        var tabla = $("#tableProyCodId").DataTable({
           ...
           // Tabla 2.6 Proyectos con Código Identificador
           var tabla = $("#tableBitacoraProyCodId").DataTable({
            "responsive": true,
            "lengthChange": true,
            "autoWidth": true,
            "dom":'lBfrtip',
        ...
        }).buttons().container().appendTo('#tableBitacoraProyCodId_wrapper .col-md-6:eq(0)');
        ...
        // Tabla 2.3.15 Lista Comprobación de Asignacion de Asesor
