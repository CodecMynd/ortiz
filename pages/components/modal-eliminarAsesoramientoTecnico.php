        ...
        <div class="modal-content">
            ...
            <form id="formEliminarAseTec">
                <div class="modal-footer text-left">
                    ...
                    <button type="button" name="btnEliminarAseTec" id="btnEliminarAseTec" class="btn btn-secondary"><i class="fas fa-ban"></i> Eliminar</button>
            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    <div id="respuestaDeleteAseTec"></div>
                </div>
            </div>
            <div class="pie">
