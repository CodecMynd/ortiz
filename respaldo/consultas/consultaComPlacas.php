<?php
	...
	while ($row = $resultado->fetch_assoc()) {
		...
		if ($super == 1) {
			$outputBtns4 = "<a href='#' onclick='abrirModal5(".$idP.",".$nP.",".$nOrden.",".$linkComPlaca.")' class='btn btn-secondary'><i class='fa-solid fa-eye'></i></a>";
		} else if ($verGralComPlacas == 1) { 
			$outputBtns4 = "<a class='btn btn-secondary'><i class='fa-solid fa-eye'></i></a>";
		} else {
			$outputBtns4 = "<a href='#' onclick='abrirModal5(".$idP.",".$nP.",".$nOrden.",".$linkComPlaca.")' class='btn btn-outline-danger' id='verGralComPlacas'><i class='fa-solid fa-comments'></i></a>";
		}
