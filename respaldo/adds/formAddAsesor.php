...
?>
<title>1.10.1 Registro de Asesor | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">1.10.1 Registro de Asesor</h1>
                        </div>
                        <div class="col-sm-6 ">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="card border-card">
                                ...
                                <form id="formNuevoAsesor" autocomplete="off">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 col-sm-12 my-1 form-group">
                                                <div class="input-group form-floating mb-3">
                                                    ...
                                                    <input autofocus name="asesor" id="asesor" type="text" class="form-control" placeholder="Ingresa un Asesor" required maxlength="40" data-toggle="tooltip" data-placement="bottom" title="Ingresa nombre completo, Max. 40 caracteres">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevoAsesor" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevoAsesor"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
