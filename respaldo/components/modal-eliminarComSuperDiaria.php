...
<div class="modal fade eliminarComSuperDiaria-<?php echo $row['id_comverifdiariaveh'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    ¿Deseas eliminar la Supervisión Link de Video en Vivo del Número de Proyecto:?
                </h5>
            </div>
            ...
            <form id="formNuevoRegComPlaca" action="../delete/deleteRegSuperDiariaVeh.php" method="POST">
                <div class="modal-body text-center">
