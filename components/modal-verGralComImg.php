...
<div class="modal fade verGralComImg<?php echo $row['id_proyecto'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="card-body">
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Link de Comprobación de 7 Imagenes </strong></h2>
                    ...
                    <div class="card-body">
                        <?php
                        if ($cI == 1) {
                            $query = "SELECT P.id_proyecto, C.linkComImagenes, C.fecha_creacion,
                            U.nombres, U.aPaterno, U.aMaterno
                            FROM proyectos P 
                            INNER JOIN comimagenes C ON P.id_proyecto = C.id_proyecto
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input'>
                                        <label for='' class='pl-5'>*Link de Comprobación de 7 Imagenes</label>
                                        <div class='input-group'>
                                            ...
                                            <input name='link' id='link<?php echo $nP ?>' type='text' class='form-control' value="<?php echo $row['linkComImagenes'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                    <div class='input-group form-floating'>
                                        ...
                                        <label for='floatingInput' class='pl-5'>Capturista: Registro Comprobación de 7 Imagenes</label>
                                    </div>
                                </div>
                                <div class='col-md-5 col-sm-12 my-5 form-group'>
                                    <div class='input-group form-floating'>
                                        ...
                                        <label for='floatingInput' class='pl-5'>Fecha: Registro Comprobación de 7 Imagenes</label>
                                    </div>
                                </div>
                            </div>
                        <?php
                ...
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Supervisión Comprobación de 7 Imagenes</strong></h2>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool text-dark " data-card-widget="collapse">
                                <i class="fas fa-plus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        if ($cSI == 1) {
                            ...
                            INNER JOIN usuarios U ON C.id_capC = U.id_usuario
                            WHERE P.id_proyecto = $idP AND C.tipoComprobacion = '7img' ";
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                        <label class='ml-5 mb-2'>Supervisión de Comprobación de 7 Imagenes</label>
