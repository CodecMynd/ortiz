...
<div class="modal fade verGralComDocuFirm<?php echo $row['id_proyecto'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="card-body">
                <div class="card card-secondary card-outline collapsed-card">
                    <div class="card-header">
                        <h2 class="card-title"><strong>Link de Comprobación de Documentación Firmada Ingreso Vehículo </strong></h2>
                    ...
                    <div class="card-body">
                        <?php
                        if ($cDF == 1) {
                            $query = "SELECT P.id_proyecto, C.linkComDocuFirm, C.fecha_creacion,
                            U.nombres, U.aPaterno, U.aMaterno
                            FROM proyectos P 
                            INNER JOIN comdocufirm C ON P.id_proyecto = C.id_proyecto
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input'>
                                        <label for='' class='pl-5'>*Link de Comprobación de Documentación Firmada Ingreso Vehículo</label>
                                        <div class='input-group'>
                                            ...
                                            <input name='link' id='link<?php echo $nP ?>' type='text' class='form-control' value="<?php echo $row['linkComDocuFirm'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-6 col-sm-12 my-5 form-group'>
                                    <div class='input-group form-floating'>
                                        ...
                                        <label for='floatingInput' class='pl-5'>Capturista: Registro Comprobación de Documentación </label>
                                    </div>
                                </div>
                                <div class='col-md-6 col-sm-12 my-5 form-group'>
                                    <div class='input-group form-floating'>
                                        ...
                                        <label for='floatingInput' class='pl-5'>Fecha: Registro Comprobación de Documentación </label>
                                    </div>
                                </div>
                            </div>
                        <?php
                ...
                <div class="card card-secondary card-outline collapsed-card">
                    ...
                    <div class="card-body">
                        ...
                        if ($cSDF == 1) {
                            ...
                            INNER JOIN usuarios U ON C.id_capC = U.id_usuario
                            WHERE P.id_proyecto = $idP AND C.tipoComprobacion = 'docufirm' ";
                            ...
                            <div class='row justify-content-center'>
                                <div class='col-md-12 col-sm-12 my-1'>
                                    <div class='form-group-input' style='border: 1px solid #CED4DA;'>
                                        <label class='ml-5 mb-2'>Supervisión de Comprobación de Documentación Firmada Ingreso Vehículo</label>
