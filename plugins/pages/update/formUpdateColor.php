...
?>
<title>1.5.2 Modificar Color | <?php echo $nomComp ?></title>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">1.5.2 Modificar Color</h1>
                        </div>
                        <div class="col-sm-6 ">
                        ...
                        <div class="col-md-8 col-sm-12">
                            <div class="card border-card">
                                <div class="card-header border-nav">
                                    <h3 class="card-title">Color seleccionado para editar</h3>
                                    <small class="float-right">*Ultima modificación: <?php echo $row['fecha_mod'] ?></small>
                                </div>

                                <form id="formUpdateColor" autocomplete="off">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 col-sm-12 my-1 form-group">
                                                <div class="input-group form-floating mb-3">
                                                    ...
                                                    <input name="color" id="color" type="text" class="form-control" placeholder="color" required maxlength="30" data-toggle="tooltip" data-placement="bottom" title="Edita la el Color" value="<?php echo $row['color'] ?>">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnUpdateColor" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaUpdateColor"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
