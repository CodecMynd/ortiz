                                                        ...
                                                        <div class=" input-group input-group-sm mb-3">
                                                            <div class="input-group-prepend">
                                                                ...
                                                                <ul class="dropdown-menu" style="columns: 2; min-width: 2em">
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="3.2.3 Descarga PDF Registro Código Identificador">
                                                                            <?php if ($super == 1) { ?>
                                                                            ...
                                                                            <?php  } else if ($pdfRpdfRepVVIvsVVA == 1) { ?>
                                                                                <a class="btn btn-secondary" href="../components/regCodIdentificador.php?id=<?php echo $row['id_proyecto'] ?>"><i class="fa-solid fa-file-pdf"></i>
                                                                                </a>
                                                                            <?php } else { ?>
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="3.2.4 Ver Link de Video, Observaciones y Generales">
                                                                            <?php if ($super == 1) { ?>
