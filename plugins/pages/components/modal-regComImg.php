<div class="modal fade regComImg-<?php echo $idP ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    Registrar Comprobacion de 7 Imagenes de Número de Proyecto: <?php echo $nP ?>
                </h5>
            </div>
                    ...
                    <div class='row justify-content-center'>
                        ...
                        <div class='col-md-10 col-sm-12 my-1'>
                            <div class='input-group form-floating mb-3'>
                                ...
                                <input name='linkComImagenes' id='linkComImagenes' type='text' class='form-control' placeholder='Link de Comprobación de 7 Imagenes' data-toggle='tooltip' data-placement='bottom' title='Ingresa Link Comprobacion de Placa'>
