                                                        ...
                                                        <div class=" input-group input-group-sm mb-3">
                                                            <div class="input-group-prepend">
                                                                ...
                                                                <ul class="dropdown-menu" style="columns: 2; min-width: 2em">
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="3.1.3 Descarga PDF Registro Código Identificador">
                                                                            <?php if ($super == 1) { ?>
                                                                    ...
                                                                    <li class="dropdown-item">
                                                                        <span data-toggle="tooltip" title="3.1.4 Ver Link de Video, Observaciones y Generales">
                                                                            <?php if ($super == 1) { ?>
