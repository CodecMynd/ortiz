                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 col-sm-12 my-1 form-group">
                                                <div class="input-group form-floating mb-3">
                                                    ...
                                                    <input autofocus name="marca" id="marca" type="text" class="form-control" placeholder="Ingresa una Marca)" required maxlength="30" data-toggle="tooltip" data-placement="bottom" title="Ingresa la Marca">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <buttom type="submit" id="btnNuevaMarca" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Guardar "><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaNuevaMarca"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
