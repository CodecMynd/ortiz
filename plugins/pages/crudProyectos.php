                    ...
                    <div class="row justify-content-center">
                        <div class="col-11">
                            <div class="card card-secondary card-outline collapsed-card">
                                ...
                                <?php
                                //# Proyectos Activos
                                $count_reg_proyectoActivo = mysqli_query($conexion, "SELECT proyectoActivo FROM proyectos WHERE proyectoActivo = 1 AND estadoproyecto = 1 ");
                                //# Registro Solicitud
                                $count_reg_registroSolicitud = mysqli_query($conexion, "SELECT registroSolicitud FROM proyectos WHERE registroSolicitud = 1 AND estadoproyecto = 1 ");
                                //# Alta Proyecto
                                $count_reg_altaProyecto = mysqli_query($conexion, "SELECT altaProyecto FROM proyectos WHERE altaProyecto = 1 AND estadoproyecto = 1 ");
                                //# Código Identificador
                                $count_reg_proyCodIdentificador = mysqli_query($conexion, "SELECT proyCodIdentificador FROM proyectos WHERE proyCodIdentificador = 1 AND estadoproyecto = 1 ");
                                //# Supervisión CodID
                                $count_reg_superCodIdentificador = mysqli_query($conexion, "SELECT superCodIdentificador FROM proyectos WHERE superCodIdentificador = 1 AND estadoproyecto = 1 ");
                                //# proyectos Registrados
                                $count_reg_proyectos = mysqli_query($conexion, "SELECT id_proyecto FROM proyectos WHERE estadoproyecto = 1 ");
                                //# proyectos Eliminados
                                $count_reg_proyectosE = mysqli_query($conexion, "SELECT id_proyecto FROM proyectos WHERE estadoproyecto = 0 ");
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-11 col-sm-12">
                            <div class="card border-card">
                                ...
                                $cont = 0;
                                if ($super == 1) {
                                    $query = "SELECT P.id_proyecto, P.nProyecto, P.nOrden, P.valorVenta, P.fecha_creacion, P.proyectoActivo, P.registroSolicitud, P.altaProyecto, P.proyCodIdentificador, P.superCodIdentificador, P.estadoProyecto,
