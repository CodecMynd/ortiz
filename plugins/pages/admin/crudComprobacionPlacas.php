                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-11 col-sm-12">
                            <div class="card border-card">
                                ...
                                $cont = 0;
                                if ($super == 1) {
                                    $query = "SELECT P.id_proyecto, P.nProyecto, P.nOrden, P.comPlacas,P.estadoProyectoEliminado,
                                                            ...
                                                            <div class="input-group-prepend">
                                                                ...
                                                                <ul class="dropdown-menu" style="min-width:2em;">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <li class="dropdown-item">
                                                                            <span data-toggle="tooltip" title="2.3.9.3 Ver Generales Comprobación de Placas">
                                                                                <?php if ($super == 1) { ?>
                                                                                ...
                                                                                <?php  } else if ($verGralComPlacas == 1) { ?>
                                                                                    <a class="btn btn-secondary" data-toggle="modal" data-target=".verGralComPlacas-<?php echo $row['id_proyecto'] ?>"><i class="fa-solid fa-eye"></i></a>
                                                                                <?php } else { ?>
